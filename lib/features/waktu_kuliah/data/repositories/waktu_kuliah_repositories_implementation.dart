...
class WaktuKuliahRepositoriesImplementation extends WaktuKuliahRepositories {
  ...
  WaktuKuliahRepositoriesImplementation({required this.localDataSource, required   this.remoteDataSource});
  ...
  Future<Either<MessageExc, List<WaktuKuliah>>> getWaktuKuliahList() async {
    try {
      ...
      final waktuKuliahEntities =
          waktuKuliahModels.map((model) => model.toEntity()).toList();
